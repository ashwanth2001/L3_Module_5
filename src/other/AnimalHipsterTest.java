...
public class AnimalHipsterTest
{
	...
	public void testAnimalHipster()
	{
		...
		assertTrue(animalHipster.findHipsters(network, favoriteAnimals).containsAll(new ArrayList<String>(Arrays.asList(new String[] {"Amy", "Elena", "Chris", "Fan-Hal"}))));
	}
	...
	public void testAnimalHipsterWithEmptyInput()
	{
		...
		assertTrue(animalHipster.findHipsters(network, favoriteAnimals).isEmpty());
	}
	...
	public void testAnimalHipsterWithEmptyNetwork()
	{
		...
		assertEquals(new HashSet<>(Arrays.asList(new String[] {"Amy", "Brie", "Chris", "Devney", "Elena", "Fan-Hal"})), new HashSet<>(animalHipster.findHipsters(network, favoriteAnimals)));
	}
}
